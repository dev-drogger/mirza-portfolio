...
const Works = () => {
  ...
  return (
    <div className="w-[100vw] max-sm:h-full max-sm:w-[100vw] px-[100px] max-sm:flex max-sm:flex-col max-sm:items-center max-sm:justify-start max-sm:px-0 max-sm:gap-20 mb-10">
      {job.map((_, index) => {
