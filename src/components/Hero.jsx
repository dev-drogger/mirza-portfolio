...
function Hero() {
  return (
    <section
      id="home"
      className={`flex md:flex-row flex-col mb-[100px] ${styles.paddingY}`}
    >
      <HeroBackground />

      <div
        id="heading"
        className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 my-[200px] mx-[100px]`}
      >
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-outfit font-semibold ss:text-[72px] text-[52px] text-white ss-leading-[100px] leading-[75px]">
            Hello, <br className="sm:block hidden" /> I Am
